...
const SERVICES = [
  ["01 / Pre-Wedding", "The Courtship", "Cinematic shoots, save-the-dates & intimate gatherings.", "photo-1681717166573-f71589207785"],
  ["02 / Haldi & Mehendi", "The Colours", "Marigold canopies, henna lounges and afternoons of joy.", "photo-1551854716-8b811be39e7e"],
  ["03 / Sangeet", "The Night", "Choreography, live acts and a stage built to dazzle.", "photo-1727430256509-0f897d6f4765"],
  ["04 / The Wedding", "The Vows", "A mandap engineered to feel eternal.", "photo-1745573674206-1d4805fcc427"],
  ["05 / Reception", "The Celebration", "Black-tie glamour, curated cuisine, a royal send-off.", "photo-1587271407850-8d438ca9fdf2"],
  ["06 / Destination", "The Escape", "Palaces, beaches, backwaters — anywhere your heart points.", "photo-1744891471118-f74c0453cd21"],
];
