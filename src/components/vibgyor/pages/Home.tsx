...
import HeroSlider from "@/components/vibgyor/HeroSlider";

const ac = (c: string) => ({ ["--accent"]: c } as React.CSSProperties);

const ALBUMS = [
  { id: "udaipur", cls: "a", img: "photo-1727430256509-0f897d6f4765", w: 1200, t: "Meera & Aarav", s: "City Palace · Udaipur", big: true },
  { id: "jaipur", cls: "b", img: "photo-1599462616558-2b75fd26a283", w: 1000, t: "Diya & Rohan", s: "Rambagh · Jaipur", big: true },
  { id: "goa", cls: "c", img: "photo-1744891471118-f74c0453cd21", w: 800, t: "Anaya & Kabir", s: "Beachfront · Goa", big: false },
  { id: "kerala", cls: "c", img: "photo-1611106211090-8f3c79eb8552", w: 800, t: "Sara & Vikram", s: "Backwaters · Kerala", big: false },
  { id: "mumbai", cls: "d", img: "photo-1587271407850-8d438ca9fdf2", w: 1200, t: "Nisha & Ishaan", s: "Grand Reception · Mumbai", big: true },
];

const SERVICES = [
  ["01 / Pre-Wedding", "The Courtship", "Cinematic shoots & intimate gatherings that set the tone.", "photo-1681717166573-f71589207785"],
  ["02 / Haldi & Mehendi", "The Colours", "Marigold canopies and afternoons drenched in joy.", "photo-1551854716-8b811be39e7e"],
  ["03 / Sangeet", "The Night", "Choreography, live acts and an unforgettable evening.", "photo-1727430256509-0f897d6f4765"],
  ["04 / The Wedding", "The Vows", "A mandap that takes the breath away.", "photo-1745573674206-1d4805fcc427"],
  ["05 / Reception", "The Celebration", "Black-tie glamour and a send-off worthy of royalty.", "photo-1587271407850-8d438ca9fdf2"],
  ["06 / Destination", "The Escape", "From Udaipur palaces to Kerala backwaters.", "photo-1744891471118-f74c0453cd21"],
];
      ...
      <main className="page">
        ...
        <div className="cinematic" style={ac("var(--red)")}>
          ...
          <div className="cin-inner">
            <div className="sec-tag center reveal" style={{ justifyContent: "center" }}>The Moment</div>
            <h2 className="cin-title reveal">When two worlds<br /><em className="gold-shimmer">become one.</em></h2>
            <p className="lead-p reveal" style={{ maxWidth: 580, margin: "1.6rem auto 0" }}>Under a canopy of light and a thousand held breaths — we engineer the moment your story has been waiting for.</p>
          </div>
        </div>
