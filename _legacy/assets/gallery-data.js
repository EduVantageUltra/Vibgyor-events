/* =====================================================
   VIBGYOR EVENTS — Gallery data
   Each home-page image links here via event.html?id=KEY
   Replace image/video URLs with your REAL footage later.
...
const SAMPLE_VID = "https://cdn.coverr.co/videos/coverr-confetti-falling-1573/1080p.mp4"; /* placeholder film — swap with real wedding films */
...
window.GALLERY = {
  udaipur:{
    ...
    media:[
      ...
      {type:"video",src:SAMPLE_VID,poster:U("photo-1583939003579-730e3918a45a")},
      ...
      {type:"video",src:SAMPLE_VID,poster:U("photo-1519225421980-715cb0215aed")},
  ...
  jaipur:{
    ...
    media:[
      ...
      {type:"video",src:SAMPLE_VID,poster:U("photo-1604017011826-d3b4c23f8914")},
      {type:"image",src:U("photo-1610047569524-29104abe2e2c")},
      {type:"image",src:U("photo-1583939003579-730e3918a45a")},
      {type:"image",src:U("photo-1595407753234-0882f1e77954")},
      {type:"video",src:SAMPLE_VID,poster:U("photo-1606800052052-a08af7148866")}
    ]
  },
  goa:{
    title:"Anaya & Kabir",
    ...
    media:[
      ...
      {type:"video",src:SAMPLE_VID,poster:U("photo-1511285560929-80b456fea0bc")},
      {type:"image",src:U("photo-1532712938310-34cb3982ef74")},
      {type:"image",src:U("photo-1583939003579-730e3918a45a")},
      {type:"image",src:U("photo-1546032996-6dfacbacbf3f")}
    ]
  ...
  kerala:{
    ...
    media:[
      ...
      {type:"image",src:U("photo-1599458448510-59aecaea4752")},
      {type:"image",src:U("photo-1606800052052-a08af7148866")},
      {type:"video",src:SAMPLE_VID,poster:U("photo-1583939411023-14783179e581")},
      {type:"image",src:U("photo-1595407753234-0882f1e77954")},
      {type:"image",src:U("photo-1604017011826-d3b4c23f8914")}
    ]
  },
  mumbai:{
    ...
    media:[
      {type:"image",src:U("photo-1599458448510-59aecaea4752")},
      {type:"video",src:SAMPLE_VID,poster:U("photo-1532712938310-34cb3982ef74")},
      {type:"image",src:U("photo-1465495976277-4387d4b0b4c6")},
      {type:"image",src:U("photo-1546032996-6dfacbacbf3f")},
      {type:"image",src:U("photo-1519225421980-715cb0215aed")},
      {type:"image",src:U("photo-1583939003579-730e3918a45a")}
  ...
  agra:{
    ...
    media:[
      ...
      {type:"image",src:U("photo-1606800052052-a08af7148866")},
      {type:"video",src:SAMPLE_VID,poster:U("photo-1610047569524-29104abe2e2c")},
      {type:"image",src:U("photo-1595407753234-0882f1e77954")},
      {type:"image",src:U("photo-1604017011826-d3b4c23f8914")},
      {type:"image",src:U("photo-1583939411023-14783179e581")}
    ]
